module 0xbadbadbad::BasicCoin {
    public struct Coin<phantom T0> has store {
        value: u64,
    }

    public struct Coin2<phantom T0> has store {
        value: u64,
        value2: u64,
    }

    public struct Balance<phantom T0> has key {
        coin: Coin<T0>,
    }
    ...
    fun pop_smallest_while_not_equal(mut arg0: vector<u64>, mut arg1: vector<u64>) : vector<u64> {
        let mut v0 = 0x1::vector::empty<u64>();
    ...
    fun test_ref_mut(mut arg0: u8) : u8 {
        let v0 = &mut arg0;
        let v1 = 4;
        *v0 = 3;
        if (v0 == &v1) {
    ...
    public fun test_swap(mut arg0: u8, mut arg1: u8) : u8 {
        if (arg0 > arg1) {
            let v0 = arg1;
            arg1 = arg0;
            arg0 = v0;
    ...
    public fun test_vector(arg0: u64) : u64 {
        let mut v0 = 0;
        let mut v1 = vector[1, 2, 3, 4, 5, 6, 7, 8, 9];
    ...
    fun test_while(mut arg0: u8, arg1: u8) : u8 {
        while (arg0 < arg1) {
            if (arg0 == 9) {
                return arg1
            };
            ...
            let mut v0 = if (arg0 > arg1 && (arg0 - arg1 * 2) / (arg1 - arg0 * 3) < arg0 + arg1) {
                arg0 - arg1
            } else {
                arg1 - arg0
            };
