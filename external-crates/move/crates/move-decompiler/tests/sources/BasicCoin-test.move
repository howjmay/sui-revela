...
module NamedAddr::BasicCoin {
    ...
    public fun test_vector(x: u64): u64 {
        let mut r = 0;
        let mut v = vector[1,2,3,4,5,6,7,8,9];
    ...
    fun test_while(mut a: u8, b: u8): u8 {
        while (a < b) {
            if (a==9) {
                return b
            };
            ...
            let mut c = if ((a > b) && (a-b*2)/(b-a*3) < a+b) {
                a - b
            } else {
                b - a
            };
    ...
    public fun test_swap(mut a: u8, mut b: u8): u8 {
        if (a>b) {
            (a,b) = (b,a);
        };
        b-a
