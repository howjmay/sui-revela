...
mod test {
    ...
    use move_decompiler::decompiler::{Decompiler, DecompilerSettings, OptimizerSettings};
    ...
    pub fn decompile_compile_decompile_match_single_file(
        ...
        utils::tmp_project(vec![("tmp.move", source.as_str())], |tmp_files| {
...

            {
                ...
                let mut decompiler = Decompiler::new(binaries, Default::default(), DecompilerSettings::default());
