...
use transform::match_return::rewrite_match_return;
...
pub(crate) fn run(
...
) -> Result<OptimizerResult, anyhow::Error> {
    ...
    Ok(OptimizerResult {
        ...
        renamed_variables: variable_index.get_old_2_new_map(),
    })
}
